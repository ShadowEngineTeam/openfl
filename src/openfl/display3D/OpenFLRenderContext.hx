...
/**
	The `OpenFLRenderContext` allows access to WebGL 2 features when OpenGL, OpenGL ES
	...
	```haxe
	var webgl2:OpenFLRenderContext = window.context;
	var webgl2:OpenFLRenderContext = gl;
	var webgl2:OpenFLRenderContext = gles3;
	var webgl2:OpenFLRenderContext = GL;
